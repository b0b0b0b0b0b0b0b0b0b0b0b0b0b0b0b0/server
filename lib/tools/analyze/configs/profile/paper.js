    ...
    'collisions.max-entity-collisions': [
      {
        expressions: [
          {
            bool: (dict_of_vars) => {
              return parseInt(dict_of_vars.paper['world-defaults.yml']['collisions']['max-entity-collisions']) >= 8;
            },
            vars: ['paper'],
          },
        ],
    ...
    'entities.armor-stands.tick': [
      {
        expressions: [
          ...
          {
            bool: (dict_of_vars) => {
              return dict_of_vars.plugins.find((plugin) => plugin.name == 'PetBlocks') !== undefined;
            },
            vars: ['plugins'],
          },
          {
            bool: (dict_of_vars) => {
              return dict_of_vars.plugins.find((plugin) => plugin.name == 'BlockBalls') !== undefined;
            },
            vars: ['plugins'],
          },
          {
            bool: (dict_of_vars) => {
              return dict_of_vars.plugins.find((plugin) => plugin.name == 'ArmorStandTools') !== undefined;
            },
            vars: ['plugins'],
          },
        ],
    ...
    'chunks.entity-per-chunk-save-limit.experience_orb': [
      {
        expressions: [
          {
            bool: (dict_of_vars) => {
              return parseInt(dict_of_vars.paper['world-defaults.yml']['chunks']['entity-per-chunk-save-limit']['experience_orb']) == -1;
            },
            vars: ['paper'],
          },
        ],
        prefix: '❌',
        value: 'Entity per-chunk save limit for experience_orb in config/paper-world-defaults.yml.\nRecommended: 16.',
      },
    ],
    'chunks.entity-per-chunk-save-limit.snowball': [
      {
        ...
        prefix: '❌',
        value: 'Entity per-chunk save limit for snowball in config/paper-world-defaults.yml.\nRecommended: 16.',
      },
    ],
    'chunks.entity-per-chunk-save-limit.ender_pearl': [
      {
        ...
        prefix: '❌',
        value: 'Entity per-chunk save limit for ender_pearl in config/paper-world-defaults.yml.\nRecommended: 16.',
      },
    ],
    'chunks.entity-per-chunk-save-limit.arrow': [
      {
        ...
        prefix: '❌',
        value: 'Entity per-chunk save limit for arrow in config/paper-world-defaults.yml.\nRecommended: 16.',
      },
    ],
  };
}
