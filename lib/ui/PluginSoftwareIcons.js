...
export function SpigotSoftwareIcon({ size = 20 }) {
  return (
...
export function ForgeIcon({ size = 20 }) {
  return (
...
export function FabricIcon({ size = 20 }) {
  return (
    <SoftwareSvg size={size}>
      <path fill="none" d="M0 0h24v24H0z" />
      <path
...
export const PLUGIN_SOFTWARE_ICONS = {
  paper: PaperIcon,
  purpur: PurpurIcon,
  velocity: VelocityIcon,
  waterfall: WaterfallIcon,
  spigot: SpigotSoftwareIcon,
  forge: ForgeIcon,
  fabric: FabricIcon,
};
