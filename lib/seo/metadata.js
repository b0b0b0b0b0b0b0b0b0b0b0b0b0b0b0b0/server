...
export function buildRootMetadata() {
  ...
  const description =
    'MTools (MST) — free Minecraft server utilities on modrinth.black: JVM flags generator with Aikar presets, startup scripts for Paper, Purpur, Velocity, and more.';
